...
public class GTG_OrderTable extends JPanel {
	...
	public void addOrderLine(){
		...
		x++;
		JComboBox<String> jcbSize = GTG_Utility.SimpleSQLComboBox(GTG_MainGUI.getSizes());
		add(jcbSize, getConstraints(x,y));
		x++;
		JComboBox<String> jcbShirtStyle = GTG_Utility.SimpleSQLComboBox(GTG_MainGUI.getColor());
		...
		x++;
		JComboBox<String> jcbColor = GTG_Utility.SimpleSQLComboBox(GTG_MainGUI.getColor());
